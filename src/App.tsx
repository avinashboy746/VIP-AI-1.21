...
import { Send, User, Bot, Sparkles, Trash2, Command, ShieldCheck, Crown, Smartphone, MessageSquare, LogOut, Github, Mail, Lock, Key, ChevronRight, UserPlus, LogIn, Globe, Cpu } from "lucide-react";
import { motion, AnimatePresence } from "motion/react";
import ReactMarkdown from "react-markdown";
import { cn } from "@/src/lib/utils";
import { chatStream, Message } from "@/src/services/gemini";
const SUGGESTIONS = [
...
export default function App() {
  ...
  if (!currentUser) {
    return (
      <div className="h-screen bg-slate-50 flex items-center justify-center relative overflow-hidden text-zinc-900 font-sans p-4">
        {/* Advanced Background Layers */}
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_-20%,#2563eb05,transparent)]" />
        ...
        <motion.div 
          ...
          className="relative z-10 w-full max-w-[440px] bg-white border border-zinc-100 rounded-[48px] overflow-hidden shadow-[0_40px_100px_rgba(0,0,0,0.05)]"
        >
          {/* Elite Accent Line */}
          ...
          <div className="p-12 flex flex-col items-center text-center">
            ...
            <div className="mb-10 relative group">
              ...
              <img 
                ...
                alt="VIP Logo" 
                className="w-32 h-32 relative z-10 rounded-[42px] border border-zinc-50 shadow-2xl transform hover:scale-105 transition-transform"
              />
            </div>
            
            <h1 className="text-4xl font-black tracking-tight mb-2 text-zinc-900 uppercase">
              VIP <span className="text-brand-blue">AI CHAT</span>
            </h1>
            <p className="text-zinc-500 text-[10px] mb-12 font-black uppercase tracking-[0.4em] leading-loose opacity-80">
            ...
            <div className="w-full space-y-6">
              <form onSubmit={handleDirectLogin} className="space-y-4">
                  ...
                  {isRegistering && (
                    <div className="relative group/input">
                      ...
                      <input 
                        ...
                        className="w-full h-14 bg-zinc-50 border border-zinc-200 rounded-2xl pl-12 pr-4 text-sm focus:outline-none focus:border-brand-blue/50 transition-all placeholder:text-zinc-300 font-medium"
                      />
                    </div>
                  )}
                  <div className="relative group/input">
                ...
                <button 
                  type="submit"
                  className="w-full h-16 bg-brand-red text-white font-black uppercase text-[11px] tracking-[0.3em] rounded-2xl hover:bg-brand-red-deep active:scale-[0.98] transition-all shadow-[0_15px_30px_rgba(220,38,38,0.2)] flex items-center justify-center gap-3"
                >
            ...
            <p className="mt-12 text-zinc-400 text-[10px] font-black uppercase tracking-[0.5em] opacity-40">
              VIP TERMINAL • SECURE LINK
            </p>
          </div>
        </motion.div>
      </div>
    ...
    <div className="flex h-screen bg-slate-50 text-zinc-900 font-sans overflow-hidden">
      ...
      <div className="relative flex flex-col flex-1 max-w-full bg-white">
        ...
        <header className="flex items-center justify-between px-10 py-6 border-b border-zinc-100 bg-white z-20">
          <div className="flex items-center gap-4">
            <img src="/input_file_7.png" alt="Logo" className="w-8 h-8 rounded-lg shadow-sm lg:hidden" />
            <div className="flex items-center gap-3">
